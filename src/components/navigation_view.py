...
def ecran_navigation(fenetre, revenir_callback, fermer_callback):
    ...
    g.bouton_filament1 = ctk.CTkButton(fenetre, text="PLA", width=105, height=50, fg_color=get_color("PLA"), hover_color="#B0B0B0", text_color="Black",
    ...
    g.cadre_elec = ctk.CTkFrame(fenetre, width=235, height=70, corner_radius=15, fg_color="#F2F2F2", border_width=1, border_color="#E0E0E0")
